...
class ncRNAlist(Resource):
    ...
    def get(self):
        ...
        args = parser.parse_args()
        ncRNA_category = ['miRNA', 'rRNA', 'tRNA', 'piRNA', 'snoRNA', 'snRNA', 'pRNA', 'scRNA']
